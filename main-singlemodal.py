...
from setting import parse_opts_single
...
def train(train_loader):
    ...
    for i, sample in enumerate(train_loader):
        MRI_img, label = sample['MRI_image'], sample['label']
...
if __name__ == '__main__':
    ...
    if sets.pretrain_path:
        ...
        params = [{'params': parameters, 'lr': sets.learning_rate * 100}]
